...
class BorrowedItemFilter(django_filters.FilterSet):
    from_library = django_filters.CharFilter(name='location')
    to_sector = django_filters.NumberFilter(name='sector')
    type = django_filters.CharFilter(name='type')
    decade = django_filters.NumberFilter(name='decade')
    sex = django_filters.CharFilter(name='sex')
